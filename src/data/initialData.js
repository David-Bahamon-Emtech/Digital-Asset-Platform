...
export const initialInstitutionalAssets = [
  { id: 'usdc', label: 'USDC Treasury Wallet', balance: 10000000, symbol: 'USDC', description: 'Manage USDC stablecoin reserves.', supply: 'Finite', blockchain: 'Stellar', isWizardIssued: false, isInstitutional: true },
  { id: 'usdt', label: 'USDT Treasury Wallet', balance: 8500000, symbol: 'USDT', description: 'Manage USDT stablecoin reserves.', supply: 'Finite', blockchain: 'Ethereum', isWizardIssued: false, isInstitutional: true },
  { id: 't-gold', label: 'Gold Token Vault', balance: 5000, symbol: 'T-GOLD', description: 'Manage reserves for Gold-backed tokens.', supply: 'Finite', blockchain: 'Polygon', isWizardIssued: false, isInstitutional: true },
  { id: 'e-cedi', label: 'eCedi Pilot Wallet', balance: 15000000, symbol: 'eGH¢', description: 'Manage reserves for eCedi CBDC.', supply: 'Finite', blockchain: 'Hedera', isWizardIssued: false, isInstitutional: true },
  { id: 'd-euro', label: 'Digital Euro Pilot Wallet', balance: 9000000, symbol: 'D-EUR', description: 'Manage reserves for Digital Euro.', supply: 'Finite', blockchain: 'Ethereum', isWizardIssued: false, isInstitutional: true },
  // Add a standard fiat account for the institution
  { id: 'inst-usd-primary', label: 'USD Primary Account', balance: 25000000, symbol: 'USD', description: 'Main operational USD account.', supply: 'N/A', blockchain: 'N/A', isWizardIssued: false, isInstitutional: true },
  { id: 'inst-eur-primary', label: 'EUR Primary Account', balance: 15000000, symbol: 'EUR', description: 'Main operational EUR account.', supply: 'N/A', blockchain: 'N/A', isWizardIssued: false, isInstitutional: true },
];
