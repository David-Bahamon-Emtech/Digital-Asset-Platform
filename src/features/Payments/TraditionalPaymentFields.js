// src/features/Payments/TraditionalPaymentFields.js
...
const TraditionalPaymentFields = ({
    ...
    settlementSpeed,
    setSettlementSpeed,
    traditionalRailsList, // Pass the list data as prop
    settlementSpeeds,     // Pass the speed data as prop
    error,                // Pass potential error for rail selection
    clearError            // Pass function to clear the error on change
}) => {
    ...
    return (
        <>
            ...
            <div className="mb-6">
                <label htmlFor="traditionalRail" className="block mb-1 font-medium text-gray-700">Payment Rail <span className="text-red-600">*</span></label>
                <select
                    id="traditionalRail"
