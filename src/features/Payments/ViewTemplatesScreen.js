...
import { useTemplates } from '../../context/TemplatesContext'; // Adjust path if needed
import { useAssets } from '../../context/AssetsContext'; // Adjust path if needed (kept in case needed later)
